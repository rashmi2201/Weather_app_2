...
class greecescreen extends StatefulWidget {
  const greecescreen({super.key});

  @override
  State<greecescreen> createState() => _greecescreenState();
}

class _greecescreenState extends State<greecescreen> {
  ...
  Future<DelhiApi> callcurrentweatherapi() async {
    final response = await http.get(Uri.parse(
        'https://api.weatherapi.com/v1/current.json?q=greece&key=e8e7dd2f09a14ba0b51103205232710'));
