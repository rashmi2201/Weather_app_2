...
class nagpurscreen extends StatefulWidget {
  const nagpurscreen({super.key});

  @override
  State<nagpurscreen> createState() => _nagpurscreenState();
}

class _nagpurscreenState extends State<nagpurscreen> {
  ...
  Future<DelhiApi> callcurrentweatherapi() async {
    final response = await http.get(Uri.parse(
        'https://api.weatherapi.com/v1/current.json?q=Nagpur&key=e8e7dd2f09a14ba0b51103205232710'));
